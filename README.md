...
This work investigates how computationally efficient neural architectures can enable real-time decoding of surface electromyography (sEMG) signals, enabling the inference of fine-grained, naturalistic motor behaviors. We introduce two state-space–model–based approaches:
